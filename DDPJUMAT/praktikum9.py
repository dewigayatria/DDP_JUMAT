...
def celcisus_ke_fahrenheit(celcius):
    hasil_konversi = (celcius *9/5) + 32
    return hasil_konversi

celcius1 = 0
print(f"hasilnya adalah {celcisus_ke_fahrenheit(celcius1)}") 
print(celcisus_ke_fahrenheit(100))
print(celcisus_ke_fahrenheit(1000))
...
def nilai_kelulusan(keterangan):
    print()
    if nilai >= 80:
        return 'lulus'
    else :
